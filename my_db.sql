...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 24, 2016 at 11:05 AM
...
CREATE TABLE IF NOT EXISTS `posting` (
  ...
  `IMAGEFILENAME` varchar(255) NOT NULL DEFAULT 'null',
  PRIMARY KEY (`ID`),
...
INSERT INTO `posting` (`ID`, `JUDUL`, `TANGGAL`, `KONTEN`, `USERNAME`, `CREATED_BY`, `IMAGEFILENAME`) VALUES
...
(27, 'Doggy nya riki', '2016-02-25', 'Ini doggy riki', 'test', 'testname', '56cd5e69aeb58.jpg'),
(28, 'test', '2016-02-25', 'asdfasdf', 'test', 'testname', 'ping.jpg'),
(29, 'TEST 2', '2016-02-25', 'aasdfasdf', 'test', 'testname', 'ping2.jpg');
...
('testname', 'test', 'testemail@testemail.com', 'd2541cc960f241d555c85f0636be16818abd170931b61c48ea2de3b30fb42fa6', 9854, '2016-02-24 07:32:21', 'c5264de456dfca1a52dd7908a7684ab25acfb15a10e2aaba5e6d8f21a300dc48'),
